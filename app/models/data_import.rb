...
#RetiredBasicSalaryRecord   user_id basic_fee     stay_be           foreign_be          region_be        null     null
  ...
  def self.import_zz_xy(path)
    ...
    option[:keys]= %w(姓名	$日期  岗位工资	 薪级工资	艰苦边远地区津贴	工改保留补贴	其他国家出台津贴	地方出台津贴	扣发工资	补发工资	生活补贴	补贴补差	活工资补差	电视补贴	驻蓉补贴	$应发工资  其他1	住房公积金	职工医疗保险费	职工个人教育费	个人所得税	扣水电费	扣失业保险费	其他扣款一	其他扣款二	其他扣款三) #BasicSalaryRecord user_id  null  station_sa position_sa       hard_be  stay_be       foreign_be        region_be     null      add_sa 
